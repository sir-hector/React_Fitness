      ...
      >
        ...
        >
          ...
          <p className="my-5">
            ...
            itaque libero non esse eos totam ut, eius excepturi mollitia alias
            minima possimus nemo laboriosam nesciunt tempora modi voluptates
            error.
          </p>
        </motion.div>
        ...
        <div className="mt-10 justify-between gap-8 md:flex">
          ...
          >
            <form
              ...
              onSubmit={onSubmit}
              method="POST"
              action="https://formsubmit.co/krauskarol7@gmail.com"
            >
              <input
          ...
          >
            <div className="w-full before:absolute before:-bottom-20 before:-right-10 before:z-[-10] md:before:content-evolvetext">
              <img className="w-full" src={ContactUsPageGraphic} alt="contant-us-page-graphic" />
            </div>
          </motion.div>
        </div>
      </motion.div>
